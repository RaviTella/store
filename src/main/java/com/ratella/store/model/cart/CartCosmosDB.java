...
public class CartCosmosDB {
    ...
    public CartCosmosDB(@Value("${database.endpoint}") final String endpoint, @Value("${database.key}") final String key,
                        @Value("${database.databaseName}") final String databaseName, @Value("${database.containerName.cart}") final String containerName,
